...
public class ContentControllerServlet extends HttpServlet {
	...
	@Resource(name = "jdbc/netscore")     //database resource
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			switch(theCommand) {
			case "MAIN":                                  // list up by score order by score
				listPopular(request, response);
				break;
			case "LIST":                                  // list up by category
				listContents(request, response);
				break;
			case "SEARCH":								// search contents with title
	...
	// delete content's review when the content written by user-self
