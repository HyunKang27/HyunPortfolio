...
<body>
	...
	<div class="container">
		<form action="ContentControllerServlet" method="POST">
			...
			<p><input class="form-control" type="email" name="userEmail" placeholder="Email" required /></p>
			<p><input class="form-control" type="password" name="userPassword" placeholder="PASSWORD" required /></p>
